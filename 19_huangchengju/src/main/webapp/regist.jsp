...
<div class="x-body layui-anim layui-anim-up">
    <form class="layui-form" method="post" action="regist.do" enctype="multipart/form-data">
        ...
        <div class="layui-form-item">
            ...
            <label id="label" style="color: red"></label> <br/>
            <div class="layui-input-inline">
